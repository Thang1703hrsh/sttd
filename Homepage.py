...
HTML_BANNER_1 = """
        <div style="background-color:#464e5f;padding:10px;border-radius:10px">
        <h1 style="color:white;text-align:center;">Dữ liệu cân bằng chuyền</h1>
        </div>
        """

HTML_BANNER_2 = """
        <div style="background-color:#464e5f;padding:10px;border-radius:10px">
        <h1 style="color:white;text-align:center;">Dữ liệu cân bằng sản xuất</h1>
        </div>
        """

HTML_BANNER_3 = """
        <div style="background-color:#464e5f;padding:10px;border-radius:10px">
        <h1 style="color:white;text-align:center;">Độ ưu tiên sản xuất</h1>
        </div>
        """
...
if authentication_status:
    with st.sidebar:
        selected = option_menu("Main Menu", ["Trang chủ" ,"Dữ liệu cân bằng chuyền", "Dữ liệu cân bằng sản xuất" , "Cân bằng chuyền" , "Độ ưu tiên sản xuất" , "Đăng xuất"], 
            icons=['house' , 'cloud-upload', 'cloud-upload' , "graph-up", 'clipboard-data' , 'box-arrow-in-right'], menu_icon="cast", default_index=0)
        # selected

    # selected2 = option_menu(None, ["Trang chủ" , "Đăng xuất"], 
    #     icons=['house' , 'box-arrow-in-right'], 
    #     menu_icon="cast", default_index=0, orientation="horizontal")
    # # selected2
    # if selected2 == "Trang chủ":
    #     st.write("home is where the heart is")
    # elif selected2 == "Đăng xuất":
    #     authenticator.logout("Logout")

    if selected == "Trang chủ":
        st.write(" ")
    elif selected == "Dữ liệu cân bằng chuyền":
        stc.html(HTML_BANNER_1)
    ...
    elif selected == "Dữ liệu cân bằng sản xuất":
        stc.html(HTML_BANNER_2)
    elif selected == "Cân bằng chuyền":
        # @st.cache
        ...
        # line.run()
        # main.mainloop()
    elif selected == "Độ ưu tiên sản xuất":
        stc.html(HTML_BANNER_3)
